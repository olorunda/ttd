...
///$route['data_syncronization/start'] = 'welcome/start';
$route['daily_synchronization'] = 'daily_sync/index/';
$route['daily_synchronization/data_syncronization_start'] = 'daily_sync/data_syncronization_start';