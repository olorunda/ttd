...
class Customers extends MY_Controller
{
    ...
    function add_user($company_id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data, $active, $notify)) {
            ...
            /*E-Mail Sending after customer has been added */
            $msg = 'Dear ' . $username . ', on behalf of the entire crew from tdafrica, we are glad you joined us. Henceforth, I will be your account manager and will bring you up to speed with our products, policies and how to make the best of our platform.\nShould in case you have any questions yuo would like to discuss, you can always reach me by my mobile on +234(0) 810 7654 663 or just shoot me a mail at deji@tdafrica.com.\nHave a splendid day.';
            $this->sma->mailNotify('support@tdafrica.com', 'Sales Team - Adedeji Adeloye', $email, 'Welcome Message', $msg,$cc=null, $bcc=null);
            /*End sending mail */
