...
class Suppliers extends MY_Controller
{
    ...
    function getSuppliers()
    {
        ...
        $this->datatables
            ...
            ->add_column("Actions", "<div class=\"text-center\"><a class=\"tip\" title='" . $this->lang->line("list_products") . "' href='" . site_url('products?supplier=$1') . "'><i class=\"fa fa-list\"></i></a> <a class=\"tip\" title='" . $this->lang->line("list_users") . "' href='" . site_url('suppliers/users/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-users\"></i></a> <a class=\"tip\" title='" . $this->lang->line("add_user") . "' href='" . site_url('suppliers/add_user/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-plus-circle\"></i></a> <a class=\"tip\" title='" . $this->lang->line("edit_supplier") . "' href='" . site_url('suppliers/edit/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-edit\"></i></a> <a href='#' class='tip po' title='<b>" . $this->lang->line("delete_supplier") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . site_url('suppliers/delete/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a></div>", "id");
        //->unset_column('id');
    ...
    function add()
    {
        ...
        if ($this->form_validation->run() == true && $sid = $this->companies_model->addCompany($data)) {
            ...
            /*E-Mail Sending after customer has been added */
            $msg = 'Dear ' . $data['name'] . ', on behalf of the entire crew from tdafrica, we are glad you joined us. Henceforth, I will be your account manager and will bring you up to speed with our products, policies and how to make the best of our platform.\nShould in case you have any questions yuo would like to discuss, you can always reach me by my mobile on +234(0) 810 7654 663 or just shoot me a mail at deji@tdafrica.com.\nHave a splendid day.';
            $this->sma->mailNotify('support@tdafrica.com', 'Sales Team - Adedeji Adeloye', $data['email'], 'Welcome Message', $msg,$cc=null, $bcc=null);
            /*End sending mail */
