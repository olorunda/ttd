...
<?php if (($Owner || $Admin) && $chatData) {
    ...
    <div class="box" style="margin-bottom: 15px;">
        ...
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                <iframe style="width: 100%;padding: 0px;" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiZTJkMWE0NjQtNzhhZS00MTM1LWFmYmYtMzgxYjJlNTZmZGYwIiwidCI6ImJhMTMwZWNhLTMwMzAtNDhlMS05MDg5LWM5NzkyOTNhZWI3MCIsImMiOjh9" frameborder="0" allowFullScreen="true"></iframe>
                </div>
            </div>
        </div>
    </div>
