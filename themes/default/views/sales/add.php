                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <input type="checkbox" class="checkbox" id="not_cust" name="not_cust" value="1">
                            <label for="extras" class="padding05"><?= lang('notify_customer', 'not_cust') ?></label>
                            <p></p>
                            <input type="checkbox" class="checkbox" checked="checked" id="not_ware" name="not_ware" value="1">
                            <label for="extras" class="padding05"><?= lang('notify_warehouse', 'not_ware') ?></label>
                            <div class="clearfix"></div>
